export function comandosInfo(botInfo){
    ...
    const comandos = {
        ...
        grupo: {
            ...
            nblk: {
                descricao: '',
                guia: `Ex: Responda alguém com *${prefixo}nblk* - Adiciona o numero de quem foi respondido a lista negra e bane em seguida.\n\n`+
                `Ex: Marque alguém com *${prefixo}nblk* - Adiciona o numero de quem foi marcado a lista negra e bane em seguida.\n\n`+
                `Ex: *${prefixo}nblk* +55219xxxx-xxxx - Adiciona o número digitado a lista negra do grupo e bane em seguida.\n.`,
                msgs: {
            ...
            unblk: {
                descricao: '',
                guia: `Ex: *${prefixo}unblk* +55219xxxx-xxxx - Remove o número digitado da lista negra do grupo.\n`,
                msgs: {
            ...
            antlink: {
                descricao: '',
                guia: `Ex: *${prefixo}antlink* - Liga/desliga o antilink e apaga a mensagem de quem postar qualquer tipo de link.\n`,
                msgs: {
                    motivo: "Banido pelo ANTI-LINK",
                    detectou: "@{p1}, 🚨🔗 𝑳𝑰𝑵𝑲 𝒅𝒆𝒕𝒆𝒄𝒕𝒂𝒅𝒐 𝒏𝒂 𝒔𝒖𝒂 𝒎𝒆𝒏𝒔𝒂𝒈𝒆𝒎! 𝑷𝒐𝒓 𝒒𝒖𝒆𝒔𝒕𝒐̃𝒆𝒔 𝒅𝒆 𝒔𝒆𝒈𝒖𝒓𝒂𝒏𝒄̧𝒂 🛡️, 𝒗𝒐𝒄𝒆̂ 𝒇𝒐𝒊 𝑩𝑨𝑵𝑰𝑫𝑶 𝒅𝒐 𝒈𝒓𝒖𝒑𝒐 🚫. 𝑹𝑬𝑺𝑷𝑬𝑰𝑻𝑬 𝑨𝑺 𝑹𝑬𝑮𝑹𝑨𝑺 📜.",
            ...
            marcaroschupacabra: {
                descricao: '',
                guia: `Ex: *${prefixo}marcaroschupacabra* 5 - Marca todos os membros com menos de 5 mensagens.\n\n`+
                `*Obs*: Este comando só funciona com o *${prefixo}contador* ativado.\n`,
                msgs: {
        ...
        outros : {
            ...
            usuario_novo: "[ 🤖 Boas Vindas ao {p1} 🤖]\n\n"+
             `👋 Olá {p2}, Este bot não responde a *mensagens privadas*. Se você insistir em enviar mensagens, você será bloqueado! ⚠️`,
